...
exports.reactionFixtures = void 0;
...
exports.reactionFixtures = [
    ...
    {
        name: '2. Bullish FVG close above midpoint remains TOUCH / no entry',
        input: {
            zone: bullishZone,
    ...
    {
        name: '5. Bullish FVG close below midpoint remains TOUCH / no failure entry',
        input: {
            zone: bullishZone,
    ...
    {
        name: '7. Bearish FVG close below midpoint remains TOUCH / no entry',
        input: {
            zone: bearishZone,
    ...
    {
        name: '10. Bearish FVG close above midpoint remains TOUCH / no failure entry',
        input: {
            zone: bearishZone,
...
function makeZone(id, direction) {
    return {
        id,
        direction,
        high: 102,
...
function candle(minute, open, high, low, close, volume = 100) {
    return {
        open,
        high,
        low,
