...
function test1StructureModeUsesOpposingFvg() {
    const opposing = bearishFvgZone({ id: 'fvg-opposing', low: 102, high: 103 });
    const result = (0, targetSelection_1.selectManagedTarget)({
        side: 'LONG',
        entryPrice: 100,
        stopPrice: 99,
...
function test2StructureModeFallsBackToSwing() {
    const result = (0, targetSelection_1.selectManagedTarget)({
        side: 'LONG',
        entryPrice: 100,
        stopPrice: 99,
...
function test3ScalpModeUsesRMultiple() {
...
function test4HybridChoosesScalpWhenStructureTooFar() {
...
function test5HybridChoosesStructureWhenNearbyAndValid() {
...
function test6TradeRejectedIfRrBelowMin() {
...
function test7TradeRejectedIfExpectedLossExceedsMax() {
...
function test8QuickProfitExitFiresWithManagedTarget() {
...
function bearishFvgZone(params) {
    return {
        id: params.id,
        type: 'FVG',
        direction: 'BEARISH',
