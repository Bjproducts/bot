...
const positionSizing_1 = require("./positionSizing");
const baseConfig = {
...
function testExpectedProfitInsideTargetRange() {
    const result = (0, positionSizing_1.calculatePositionSizing)(baseInput);
...
function testExpectedLossCapped() {
...
function testLowConfidenceReducesSize() {
    const normal = (0, positionSizing_1.calculatePositionSizing)({ ...baseInput, confidence: 88 });
    const low = (0, positionSizing_1.calculatePositionSizing)({ ...baseInput, confidence: 79 });
    return {
...
function testHighConfidenceIncreasesSize() {
    const normal = (0, positionSizing_1.calculatePositionSizing)({ ...baseInput, confidence: 88 });
    const high = (0, positionSizing_1.calculatePositionSizing)({ ...baseInput, confidence: 96 });
    return {
...
function testMaxPositionRespected() {
...
function testMinPositionRespected() {
...
function testLowRiskRewardRejected() {
    const result = (0, positionSizing_1.calculatePositionSizing)({
        ...baseInput,
        targetPrice: 101,
        stopPrice: 99,
...
function testRiskFirstTargetsOneDollarRisk() {
    const result = (0, positionSizing_1.calculatePositionSizing)({
        ...baseInput,
        entryPrice: 100,
        targetPrice: 110,
...
function testRiskFirstShortTargetUsesPriceRMultiple() {
    const result = (0, positionSizing_1.calculatePositionSizing)({
        ...baseInput,
        signal: 'SELL',
        entryPrice: 100,
...
function testRiskFirstRejectsWhenMaxPositionPreventsProfit() {
...
function testRiskFirstRejectsWhenMinPositionExceedsRisk() {
...
function testRiskUtilizationWarningOnMaxClamp() {
    const config = {
        ...riskFirstConfig,
