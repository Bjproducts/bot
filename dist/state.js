...
function recordDcaEntry(currentState, fillPrice, fillAmount, usdCost, side, options = {}) {
    ...
    const updatedState = {
        ...
        partialCloseDone: currentState.partialCloseDone,
        partialClosePrice: currentState.partialClosePrice,
        partialCloseTime: currentState.partialCloseTime,
        partialCloseFraction: currentState.partialCloseFraction,
        realizedPartialPnlUsd: currentState.realizedPartialPnlUsd,
        remainingSizeAfterPartial: currentState.remainingSizeAfterPartial,
        finalRunnerPnlUsd: currentState.finalRunnerPnlUsd,
        totalPnlUsd: currentState.totalPnlUsd,
        maxFavorableExcursionUsd: currentState.maxFavorableExcursionUsd,
        maxAdverseExcursionUsd: currentState.maxAdverseExcursionUsd,
        ...
        stopModel: currentState.stopModel,
        originalStopPrice: currentState.originalStopPrice,
        tightStopPrice: currentState.tightStopPrice,
        selectedStopPrice: currentState.selectedStopPrice,
        stopTightened: currentState.stopTightened,
        stopTighteningReason: currentState.stopTighteningReason,
        oppositeSignalProtected: currentState.oppositeSignalProtected,
