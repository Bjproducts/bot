...
const factory_1 = require("./marketData/factory");
...
const dataSource = (0, factory_1.createMarketDataSource)(config);
const journal = new tradeJournal_1.TradeJournal();
const engine = new bot_1.BotEngine(config, dataSource, journal);
...
function isLiveArmed() {
    return !config.requireManualArm || config.liveArmConfirm === exchangeTypes_1.LIVE_ARM_CONFIRMATION;
}
